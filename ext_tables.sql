...
CREATE TABLE pages (
    ...
    tx_chatbot_color_user_text varchar(10) DEFAULT '' NOT NULL,
    tx_chatbot_color_outline varchar(10) DEFAULT '' NOT NULL,
    tx_chatbot_position varchar(20) DEFAULT '' NOT NULL,
    tx_chatbot_offset_x int(11) unsigned DEFAULT '0' NOT NULL,
    tx_chatbot_offset_y int(11) unsigned DEFAULT '0' NOT NULL,
